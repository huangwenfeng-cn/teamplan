...
import teamplan
from teamplan.api import invite_by_email
from teamplan.gemoji import get_random_gemoji
from teamplan.mixins.archivable import Archivable
from teamplan.mixins.manage_members import ManageMembersMixin
...
class GPProject(ManageMembersMixin, Archivable, Document):
	...
	def invite_guest(self, email):
		invite_by_email(email, role="teamplan Guest", projects=[self.name])
