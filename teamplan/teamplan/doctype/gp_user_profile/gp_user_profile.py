...
class GPUserProfile(Document):
	...
	def set_image(self, image):
		...
		self.save()
		teamplan.refetch_resource("Users")
...
def remove_imgbg_in_background(profile_name, default_color=None):
	from teamplan.teamplan.doctype.gp_user_profile.profile_photo import remove_background
	...
	profile.save()
	teamplan.refetch_resource("Users", user=profile.user)
